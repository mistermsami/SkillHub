...
<div class="flex-grow-1 align-items-center">
    ...
    <main class="dashboard-main min-vh-100">
        <div class="d-flex flex-column gap-4">
            <!-- Header -->
            <div>
                <h3 class="text-24 fw-bold text-dark-300 mb-2">Account Delete</h3>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li class="text-lime-300 fs-6">Account Delete</li>
                </ul>
            </div>
            <!-- Content -->
            <div class="d-flex justify-content-center">
                <div class="bg-white p-4 p-md-5 rounded-4">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        <span class="mb-30"><svg xmlns="http://www.w3.org/2000/svg" width="136" height="136"
                        ...
                        <p class="text-dark-200 mb-30 text-center">
                            Notice: Remember you will not able to login this account
                            <br />
                            after delete your account.
                        </p>
                        <div class="d-flex gap-4 align-items-center">
                            <button class="w-btn-secondary-lg">Yes Delete</button>

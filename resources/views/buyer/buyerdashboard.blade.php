            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="p-4 d-flex align-items-center dashobard-widget justify-content-between bg-white rounded-4">
                <div>
                  ...
                  <p class="text-18 text-dark-200">Total Balance</p>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="p-4 d-flex align-items-center dashobard-widget justify-content-between bg-white rounded-4">
                <div>
                  ...
                  <p class="text-18 text-dark-200">Total Job</p>
                </div>
                <div class="dashboard-widget-icon">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="p-4 d-flex align-items-center dashobard-widget justify-content-between bg-white rounded-4">
                <div>
                  ...
                  <p class="text-18 text-dark-200">Complete Order</p>
                </div>
                <div class="dashboard-widget-icon">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="p-4 d-flex align-items-center dashobard-widget justify-content-between bg-white rounded-4">
                <div>
                  ...
                  <p class="text-18 text-dark-200">Active Order</p>
                </div>
                <div class="dashboard-widget-icon">
                ...
                <table class="w-100 dashboard-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-dark-200">$15</td>
                      <td>
                        <span class="status-badge canceled"> Complete </span>
                      </td>
                      <td class="text-dark-200">02</td>
                      <td>
                        <div class="d-flex justify-content-end gap-2">

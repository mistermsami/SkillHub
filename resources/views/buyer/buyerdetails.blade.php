                ...
                <div class="row">
                    <div class="col-auto">
                        <div class="position-relative z-2" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                            <h2 class="section-title-light mb-2">Buyer Details</h2>
                            ...
                            <div class="freelancer-sidebar-card p-4 rounded-4 bg-white position-relative">
                                <div
                                    ...
                                    <h3 class="fw-bold freelancer-name text-dark-300 mb-2">
                                        {{ $buyerdetails->user->firstname }}&nbsp;{{ $buyerdetails->user->lastname }}
                                    </h3>
                                    {{-- <p class="text-dark-200 mb-1">{{ $buyerdetails->user->FS_role }}</p> --}}
                                    <p>
                                ...
                                <div
                                    class="d-flex gap-4 justify-content-center sidebar-rate-card bg-offWhite p-4 rounded-4">
                                    <div>
                                        <p class="text-dark-300 fw-medium">Location</p>
                                        <p class="text-dark-200">{{ $buyerdetails->user->city }}</p>
                                    </div>
                                    {{-- <div>
                                ...
                                <ul class="py-4">
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="text-dark-300 fw-medium">{{ $buyerdetails->user->city }},
                                            {{ $buyerdetails->user->country }}</p>
                                    </li>
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        <p class="text-dark-200">Member Since:</p>
                                        <p class="text-dark-300 fw-medium">
                                            {{ $buyerdetails->user->created_at->format('F j, Y') }}</p>
                                    </li>
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        <p class="text-dark-200">Gender:</p>
                                        <p class="text-dark-300 fw-medium">{{ $buyerdetails->user->gender }}</p>
                                    </li>
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        <p class="text-dark-200">Language:</p>
                                        <p class="text-dark-300 fw-medium">{{ $buyerdetails->user->language }}</p>
                                    </li>
                                </ul>
                            ...
                            <div class="bg-white freelancer-tab-content">
                                <div class="row g-4">
                                    <div class="freelancer-single-info  pb-4">
                                        ...
                                        <p class="text-dark-200 fs-6 p-5">
                                            {{ $buyerdetails->FB_about }}
                                        </p>
                                    </div>
                                </div>

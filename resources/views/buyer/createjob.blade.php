    ...
    <div class="flex-grow-1 align-items-center">
        ...
        <main class="dashboard-main min-vh-100">
            <div class="d-flex flex-column gap-4 pb-110">
                <!-- Header -->
                <div>
                    <h3 class="text-24 fw-bold text-dark-300 mb-2">Create New Job</h3>
                                            ...
                                            <div class="row g-4">
                                                <div class="col-12">
                                                    <div class="form-container">
                                                        ...
                                                        <input type="text"name="J_title" class="form-control shadow-none"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-container">
                                                        ...
                                                        <input type="text" name="J_budget" placeholder="Price"
                                                            class="form-control shadow-none" required/>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <label for="description" class="form-label">Description*</label>
                                                    <textarea class="form-control shadow-none" name="J_description" rows="4" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

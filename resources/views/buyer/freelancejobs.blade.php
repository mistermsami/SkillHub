                ...
                <div class="row">
                    <div class="col-auto">
                        <div class="position-relative z-2" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                            <h2 class="section-title-light mb-2">Freelance Jobs</h2>
            ...
            <div class="container">
                <div class="row gap-4 justify-content-between mb-40">
                            ...
                            <form action="">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center job-post-input">
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="6.83268" cy="7.00004" r="4.66667" stroke="#A7AEBA"
                                                stroke-width="1.5" />
                                            <circle cx="6.83203" cy="7" r="1.75" stroke="#A7AEBA"
                                                stroke-width="1.5" />
                                            <path d="M6.83203 2.33329V1.16663" stroke="#A7AEBA" stroke-width="1.5"
                                                stroke-linecap="round" />
                                            <path d="M6.83203 12.8333V11.6666" stroke="#A7AEBA" stroke-width="1.5"
                                                stroke-linecap="round" />
                                        ...
                                        <input type="text" class="form-control shadow-none" placeholder="Location" />
                                    </div>
                                    <div class="d-flex align-items-center job-post-input">
                                    ...
                                    <div class="ps-3 flex-shrink-0">
                                        <button class="job-filter-btn">Find Job</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-auto">
                        <div>
                            <nav>
                                <div class="nav tab-nav d-flex gap-3 align-items-center" id="nav-tab" role="tablist">
                                    <button class="tab-link active" id="nav-grid-tab" data-bs-toggle="tab"
                                    ...
                                    <button class="tab-link" id="nav-list-tab" data-bs-toggle="tab"
                            ...
                            <article>
                                <div class="job-post bg-white position-relative">
                                    <div class="job-type-badge position-absolute d-flex flex-column gap-2">
                                        <p class="job-type-badge-tertiary">Hourly</p>
                                        <p class="job-type-badge-secondary">Urgent</p>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <div class="job-post-icon">
                                            <img src='{{asset('assets/img/job/'. $images[$i +1])}}' alt="" />
                                        </div>
                                        <p class="job-post-subtitle fw-normal">${{ $job->J_budget }}</p>
                                        <h3 class="job-post-title fw-semibold">
                                            <a href="#">
                                                {{ Str::limit($job->J_title, 35) }}
                                            </a>
                                        </h3>
                                        <a href="{{asset('jobdetails/'.$job->J_id)}}" class="w-btn-primary-lg">
                                            Apply Now
                            ...
                            <article>
                                <div class="job-post bg-white position-relative">
                                    ...
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <p class="job-post-subtitle fw-normal">$10 - $15</p>
                                        <h3 class="job-post-title fw-semibold">
                                            <a href="job-details.html">
                                                Senior Sales and Marketing Executive
                                            </a>
                                        </h3>
                                        <a href="job-details.html" class="w-btn-primary-lg">
                                            Apply Now
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="10"
                                                viewBox="0 0 14 10" fill="none">
                                                <path d="M9 9L13 5M13 5L9 1M13 5L1 5" stroke="currentColor"
                        ...
                        <div class="row">
                            ...
                            <article class="col-xl-4 col-md-6 mb-4">
                                <div class="job-post-horizontal align-items-center d-flex gap-3 bg-white">
                                    <div class="job-post-horizontal-img d-flex justify-content-center align-items-center" style="background-color: #13544e; height: 158px; width: 125px; border-radius: 8px;">
                                        <img src="{{asset('assets/img/job/'. $images[$i +1])}}" alt="" />
                                    </div>

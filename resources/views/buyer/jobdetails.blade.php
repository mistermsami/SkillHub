...
@section('maincontent')
                ...
                <div class="row">
                    <div class="col-auto">
                        <div class="position-relative z-2" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                            <h2 class="section-title-light mb-2">Job Details</h2>
                                        ...
                                        <div>
                                            <p class="job-type d-flex gap-2 align-items-center mb-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10"
                                                    ...
                                                    <path d="M4.6875 5.33337H6.6875V6.00004H4.6875V5.33337Z"
                                                        fill="#22BE0D" />
                                                    <path
                                            ...
                                            <div class="d-flex gap-3">
                                                <span class="job-post-date"><svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <span class="job-location">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="11"
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            fill="#13544E" />
                                                    </svg>{{ $jobdetail->freelanceBuyer->user->country }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        @if (session()->has('freelancerId'))
                                            <a href="#" type="button" class="header-btn" data-bs-toggle="modal"
                                                data-bs-target="#jobDetailsModal">
                                                Apply Now
                                            </a>
                                        @else
                                            <a href="#" type="button" class="header-btn"
                                                style="background-color: gray">
                                                Apply Now
                                            </a>
                                        @endif
                                        <h3 class="job-wage fw-bold mt-4">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${{ $jobdetail->J_budget }}</h3>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white company-profile-card">
                                <div class="d-flex gap-3 align-items-center company-profile-card-header">
                                    <div class="company-profile-card-icon">
                                        <img src="{{ asset('profile_images/' . $jobdetail->freelanceBuyer->user->profileimage) }}"
                                            alt="" style="height: 78px; width: 78px; border-radius: 8px;" />
                                    </div>
                                    <div>
                                        <h4 class="company-profile-card-title fw-bold">
                                            {{ $jobdetail->freelanceBuyer->user->firstname }}&nbsp;{{ $jobdetail->freelanceBuyer->user->lastname }}
                                        </h4>
                                        <p class="company-profile-card-desc">{{ $jobdetail->freelanceBuyer->user->city }},
                                            {{ $jobdetail->freelanceBuyer->user->country }}</p>
                                    </div>
                                </div>
                                <ul class="company-card-list">
                                    <li
                                        ...
                                        <div class="d-flex gap-3 align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20"
                                                ...
                                                <path
                                                    ...
                                                    fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4" />
                                                <path
                                        ...
                                        <span
                                            class="text-dark-200 fs-6">{{ $jobdetail->freelanceBuyer->user->created_at->format('F j, Y') }}</span>
                                    </li>
                                    {{-- <li
                                        class="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                                        <div class="align-items-center d-flex gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#22BE0D" stroke-width="1.4" />
                                                <path
                                    ...
                                    <li
                                        class="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                                        <div class="d-flex gap-3 text-dark-200 align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21"
                                                viewBox="0 0 21 21" fill="none">
                                                <mask id="mask0_426_8309" style="mask-type: luminance"
                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="21">
                                                    <path d="M20.0167 20.0167V0.65H0.65V20.0167H20.0167Z" fill="white"
                                                ...
                                                <g mask="url(#mask0_426_8309)">
                                                    <path
                                                        ...
                                                        stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M5.32812 3.14856H15.3386" stroke="#22BE0D" stroke-width="1.3"
    ...
    <!-- Modal -->
    <div class="modal fade" id="jobDetailsModal" tabindex="-1" aria-labelledby="jobDetailsModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="bg-white p-lg-5 rounded-3">
                        <div class="proposal-container">
                            ...
                            <form method="POST" action="{{ route('storeproposal', $jobdetail->J_id) }}">
                                @csrf
                                <div class="d-flex flex-column gap-4">
                                    <!-- Todo Need to add select -->
                                    <div class="proposal-input-container">
                                        <label for="time" class="proposal-form-label">Select Gig*</label>
                                        <select name="G_id" id="time" class="form-select shadow-none">
                                            @if (session()->has('freelancerId'))
                                                @foreach ($gigs as $gig)
                                                    <option value="{{ $gig->G_id }}">{{ $gig->G_title }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    <div class="proposal-input-container">
                                        ...
                                        <textarea placeholder="Write Cover Letter minimum 150 characters..." name="P_coverletter"
                                            class="form-textarea shadow-none"></textarea>
                                    </div>
                                    <div class="d-flex gap-4 align-items-center justify-content-end">
                                        <button class="w-btn-gray-sm" data-bs-dismiss="modal">
                                            Cancel
                                        </button>
                                        <button class="w-btn-secondary-sm" type="submit">
                                            Submit Proposal
                                        </button>
                                    </div>
                                </div>

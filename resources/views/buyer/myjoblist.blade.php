                                                    ...
                                                    <div class="bg-offWhite p-4 rounded-4">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <form
                                                                    action="{{ route('acceptProposal', [$proposal->P_id, $job->J_id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                ...
                                                                <form
                                                                    action="{{ route('declineProposal', $proposal->P_id, $job->J_id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <button class="w-btn-secondary-lg" type="submit"
                                                                        style="background-color: rgb(255, 56, 56)">
                                                                        Decline Order
                                                                    </button>
                                                                </form>

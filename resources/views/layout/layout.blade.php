...
<head>
    ...
    <title>@yield('pagetitle') - SkillHub</title>
    <!-- GLightBox -->
...
<body>
    ...
    <header class="header-primary header-transparent">
        <div class="container">
            <nav class="navbar navbar-expand-xl justify-content-between">
                <a href="{{ asset('/') }}">
                    <img src="{{ asset('assets/img/logo/1logo-dark-Copy.png') }}" class="logo-transparent" alt="" height="100" />
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        @if (session()->has('buyerId'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ asset('/buyerdashboard') }}">Dashboard</a>
                            </li>
                        ...
                        @if (session()->has('studentId'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ asset('/studentdetails') }}">View Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ asset('/profilesetting') }}">Profile Settings</a>
                            </li>
                        @endif
                        {{-- <li class="nav-item">
    ...
    <footer class="footer-area">
        <div class="bg-dark-300 pt-110">
            <div class="container">
                <!-- Newsletter -->
                <div class="footer-newsletter pb-60" data-aos="fade-right" data-aos-duration="1000"
                    data-aos-easing="linear">
                    <div class="row justify-content-between row-gap-4">
                        <div class="col-lg-6 col-xl-4">
                            <div>
                                <a href="index.html" class="d-block mb-4">
                                    <img src="{{ asset('assets/img/logo/logo-dark.svg') }}" alt="" />
                                </a>
                                <p class="text-white">
                ...
                <div class="footer-widgets py-60">
                    <div class="row justify-content-between row-gap-4">
                        <div class="col-md-6 col-xl-3" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-easing="linear">
                            <div class="mb-5">
                            ...
                            <div>
                                ...
                                <div class="d-flex gap-3">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/logo/play.svg') }}" alt="" />
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/img/logo/appstore.svg') }}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <a href="http://" class="footer-social-link" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path
                                        ...
                                        fill="currentColor" />
                                </svg> </a><a href="http://" class="footer-social-link" target="_blank"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path
                                        d="M8.9419 19.8229C8.95978 19.9197 8.86042 20.0205 8.71735 20.0442C8.57428 20.0679 8.4491 20.0106 8.43121 19.9158C8.41333 19.8209 8.51666 19.7182 8.65576 19.6925C8.79485 19.6668 8.92401 19.7261 8.9419 19.8229Z"
                                        fill="currentColor" />
                                    <path
                                        d="M7.04617 19.9079C7.01637 20.0008 6.88124 20.0423 6.74612 20.0027C6.611 19.9632 6.52158 19.8526 6.54741 19.7577C6.57325 19.6629 6.71036 19.6194 6.84747 19.6629C6.98457 19.7064 7.07201 19.8111 7.04617 19.9079Z"
                                        fill="currentColor" />
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path
                                        d="M5.50437 18.8568C5.43085 18.9082 5.30565 18.8568 5.2361 18.754C5.21687 18.7356 5.20158 18.7135 5.19113 18.6891C5.18068 18.6646 5.17529 18.6383 5.17529 18.6118C5.17529 18.5852 5.18068 18.5589 5.19113 18.5345C5.20158 18.5101 5.21687 18.488 5.2361 18.4695C5.30963 18.4201 5.43482 18.4695 5.50437 18.5703C5.57391 18.6711 5.5759 18.8054 5.50437 18.8568Z"
                                        fill="currentColor" />
                                    <path
                                        d="M5.03123 18.1711C4.99008 18.1918 4.943 18.1975 4.89805 18.1874C4.8531 18.1773 4.81308 18.152 4.78483 18.1158C4.70734 18.0328 4.69143 17.9182 4.75104 17.8669C4.81066 17.8155 4.91797 17.8392 4.99546 17.9222C5.07296 18.0052 5.09084 18.1198 5.03123 18.1711Z"
                                        fill="currentColor" />
                                    <path

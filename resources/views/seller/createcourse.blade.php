                                            ...
                                            <div class="row g-4">
                                                <div class="col-12">
                                                    <div class="form-container">
                                                        ...
                                                        <input type="text"name="C_title" class="form-control shadow-none"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-container">
                                                        <label for="category" class="form-label">Select
                                                            Category*</label>
                                                        <select name="CC_id" id="CC_id" autocomplete="off"
                                                            class="form-select shadow-none">
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->CC_id }}">
                                                                    {{ $category->CC_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-container">
                                                        ...
                                                        <input type="text" name="C_price" placeholder="Price"

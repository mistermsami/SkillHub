                ...
                <div>
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            ...
                            @endif
                            <form action="{{ route('storeGig') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="row g-4">
                                                <div class="col-12">
                                                    <div class="form-container">
                                                        ...
                                                        <input type="text"name="G_title" class="form-control shadow-none"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-container">
                                                        <label for="category" class="form-label">Select
                                                            Category*</label>
                                                        <select name="FCat_id" id="FCat_id" autocomplete="off"
                                                            class="form-select shadow-none">
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->FCat_id }}">
                                                                    {{ $category->FCat_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-container">
                                                        ...
                                                        <input type="text" name="G_price" placeholder="Price"
                                                            class="form-control shadow-none" required />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <label for="description" class="form-label">Description*</label>
                                                    <textarea class="form-control shadow-none" name="G_description" rows="4" required></textarea>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-container">

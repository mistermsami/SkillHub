                            ...
                            <div class="freelancer-sidebar-card p-4 rounded-4 bg-white position-relative">
                                <div class="job-type-badge position-absolute d-flex flex-column gap-2">
                                    ...
                                    <p class="job-type-badge-secondary">
                                        {{ $freelancerdetials->FS_hourlyrate ? $freelancerdetials->FS_hourlyrate . '/hr' : '0' }}
                                    </p>
                                </div>
                                <div
                                    class="freelancer-sidebar-card-header d-flex flex-column justify-content-center align-items-center py-4">
                                    <img src="{{ asset('profile_images/' . $freelancerdetials->user->profileimage) }}"
                                        class="freelancer-avatar rounded-circle mb-4" alt="" />
                                    <h3 class="fw-bold freelancer-name text-dark-300 mb-2">
                                        {{ $freelancerdetials->user->firstname }}&nbsp;{{ $freelancerdetials->user->lastname }}
                                    </h3>
                                    <p class="text-dark-200 mb-1">{{ $freelancerdetials->user->FS_role }}</p>
                                    <p>
                                        ...
                                        @php
                                            ...
                                            // Check if the freelancer has gigs and their proposals
                                            if ($freelancerdetials && $freelancerdetials->gigs) {
                                                // Get all proposals from the freelancer's gigs
                                                $proposals = $freelancerdetials->gigs->flatMap->proposals;

                                                // Check if there are any proposals and ratings available
                                                if ($proposals->isNotEmpty()) {
                                                    // Calculate the average rating from the proposals
                                                    $averageRating = $proposals->avg('rating');

                                                    // Count the number of proposals with a rating
                                                    $ratingCount = $proposals->whereNotNull('rating')->count();
                                                }
                                            }
                                        @endphp

                                        <span class="text-dark-300">{{ number_format($averageRating, 2) }}</span>
                                        <span class="text-dark-200"> ({{ $ratingCount }} Reviews)</span>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-dark-200">{{ $freelancerdetials->user->city }}</p>
                                    </div>
                                    <div>
                                        <p class="text-dark-300 fw-medium">Rate</p>
                                        <p class="text-dark-200">${{ $freelancerdetials->FS_hourlyrate }}/hr</p>
                                    </div>
                                    {{-- <div>
                                ...
                                <ul class="py-4">
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="text-dark-300 fw-medium">{{ $freelancerdetials->user->city }},
                                            {{ $freelancerdetials->user->country }}</p>
                                    </li>
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        <p class="text-dark-200">Member Since:</p>
                                        <p class="text-dark-300 fw-medium">
                                            {{ $freelancerdetials->user->created_at->format('F j, Y') }}</p>
                                    </li>
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        <p class="text-dark-200">Gender:</p>
                                        <p class="text-dark-300 fw-medium">{{ $freelancerdetials->user->gender }}</p>
                                    </li>
                                    <li class="py-1 d-flex justify-content-between align-items-center">
                                        <p class="text-dark-200">Language:</p>
                                        <p class="text-dark-300 fw-medium">{{ $freelancerdetials->user->language }}</p>
                                    </li>
                                </ul>
                                ...
                                <div class="freelancer-single-info border-bottom py-4">
                                    ...
                                    <div class="freelancer-skills d-flex flex-wrap gap-3">
                                        @foreach ($skillsArray as $skill)
                                            <span class="single-skill">{{ $skill }}</span>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <article class="col-xl-4 col-md-6">
                                            <div class="service-card bg-white w-shadow">
                                                <div class="position-relative">
                                                    <img src="{{ asset('gig_images/' . $gig->G_image) }}"
                                                ...
                                                <div class="service-card-content">
                                                    ...
                                                    <h3 class="service-card-title fw-semibold">
                                                        <a href="{{ asset('gigdetails/' . $gig->G_id) }}">
                                                            {{ Str::limit($gig->G_title, 30) }}
                                                        </a>
                                                    </h3>
                                                    <div class="d-flex align-items-center service-card-author">
                                                        ...
                                                        <a href="#"
                                                            class="service-card-author-name">{{ $freelancerdetials->user->firstname }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>

    ...
    <main class="dashboard-main min-vh-100 vw-100">
        <div class="d-flex flex-column gap-4">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center gap-4 justify-content-between">
                <div>
                    <h3 class="text-24 fw-bold text-dark-300 mb-2">Manage Gig</h3>
                    <ul class="d-flex align-items-center gap-2">
                        ...
                        <li class="text-lime-300 fs-6">Manage Gig</li>
                    </ul>
                </div>
                <div>
                    <a href="{{ asset('creategig') }}" class="w-btn-secondary-lg"> Create a new Gig </a>
                </div>
            </div>
            <!-- Content -->
            <div>
                        ...
                        <article>
                            <div class="service-card bg-white">
                                <div class="position-relative">
                                    <img src="{{ asset('gig_images/' . $gig->G_image) }}" class="recently-view-card-img w-100"
                                ...
                                <div class="service-card-content">
                                    ...
                                    <h3 class="service-card-title fw-semibold">
                                        <a href="{{asset('gigdetails/'.$gig->G_id)}}"> {{ Str::limit($gig->G_title, 100) }}</a>
                                    </h3>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="form-check gig-status form-switch m-0">
                                    <input class="form-check-input shadow-none" type="checkbox"
                                        role="switch" id="flexSwitchCheckChecked" checked />
                                </div>
                            </div>
                            <div>
                                <button class="gig-edit-btn">Edit Gig</button>
                            </div>
                        </div> --}}
                            </div>
                        </article>

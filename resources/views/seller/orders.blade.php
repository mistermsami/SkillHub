                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex gap-3 align-items-center project-name">
                                                                ...
                                                                <div>
                                                                    <a href="#" class="text-dark-200 project-link">
                                ...
                                <div class="overflow-x-auto">
                                    <div class="w-100">
                                        <table class="w-100 dashboard-table">
                                            ...
                                            <tbody>
                                                @foreach ($proposals as $proposaldetail)
                                                    @if ($proposaldetail->P_status == 'accepted')
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex gap-3 align-items-center project-name">
                                                                    <div class="order-img">
                                ...
                                <div class="overflow-x-auto">
                                    <div class="w-100">
                                        <table class="w-100 dashboard-table">
                                            ...
                                            <tbody>
                                                @foreach ($proposals as $proposaldetail)
                                                    @if ($proposaldetail->P_status == 'declined')
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex gap-3 align-items-center project-name">
                                                                    <div class="order-img">
                                            ...
                                            <div class="bg-white p-3 rounded-3 mt-4">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($proposaldetail->P_status == 'accepted')
                                                        <form action="{{ route('ordercompleted', [$proposaldetail->P_id, $proposaldetail->job->J_id]) }}"
                                                            method="POST" enctype="multipart/form-data">
                                                          @csrf
                                                          <div class="col-12 p-4">
                                                              <div class="form-container">
                                                                  <label for="title" class="form-label">Upload Task file</label>
                                                                  <input type="file" name="worksubmit" class="form-control shadow-none" accept=".zip,.doc,.docx,.ppt,.pptx,.xls,.xlsx" required>
                                                              </div>
                                                          </div>
                                                        ...
                                                        @elseif($proposaldetail->P_status == 'completed')
                                    ...
                                    <div class="d-grid gap-3">
                                        <div>
                                            <label for="upload-work" class="border rounded-2 p-3 text-center">
                                                ...
                                                <input class="d-none" type="file" name="" id="upload-work" />
                                            </label>

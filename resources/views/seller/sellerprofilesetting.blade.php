                    ...
                    <div>
                        <div class="row justify-content-center">
                            <div class="col-xl-8">
                                ...
                                @endif
                                <form action="{{ route('sellerprofileupdate') }}" method="POST"
                                    ...
                                    <div class="d-flex flex-column gap-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input type="text" class="form-control shadow-none"
                                                                ...
                                                                value="{{ $freelanferdetails->user->firstname }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input type="text" class="form-control shadow-none"
                                                                ...
                                                                value="{{ $freelanferdetails->user->lastname }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input type="text" class="form-control shadow-none"
                                                                ...
                                                                value="{{ $freelanferdetails->user->username }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input type="text" class="form-control shadow-none"
                                                                ...
                                                                value="{{ $freelanferdetails->user->email }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="description" class="form-label">Description
                                                            <span class="text-lime-300">*</span></label>
                                                        <textarea type="text" class="form-control shadow-none" name="description" id="" rows="5">{{ $freelanferdetails->FS_about }}</textarea>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input type="text" class="form-control shadow-none"
                                                                name="country" id=""
                                                                value="{{ $freelanferdetails->user->country }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input type="text" class="form-control shadow-none"
                                                                name="city" id=""
                                                                value="{{ $freelanferdetails->user->city }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input id="designation" type="text"
                                                                ...
                                                                placeholder="example@email.com" name="designation"
                                                                value="{{ $freelanferdetails->FS_role }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input id="rate" type="text"
                                                                class="form-control shadow-none"
                                                                placeholder="example@email.com" name="rate"
                                                                value="{{ $freelanferdetails->FS_hourlyrate }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-container">
                                                            ...
                                                            <input id="language" type="text"
                                                                ...
                                                                value="{{ $freelanferdetails->user->language }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="profile-info-card">
                                            ...
                                            <div class="profile-info-body bg-white">
                                                {{-- @if ($freelanferdetails->user->profileimage)
                                                    <div class="mt-2 mb-2">
                                                        <img src="{{ asset('profile_images/' . $freelanferdetails->user->profileimage) }}"
                                                            style="height: 100px;" alt="">
                                                        <img src="{{ $freelanferdetails->user->image_base64 }}"
                                                            style="height: 100px;" alt="">
                                                    </div>
                                                @endif --}}
                                                @if ($freelanferdetails->user->image_base64)
                                                    <div class="mt-2 mb-2">
                                                        <img src="{{ $freelanferdetails->user->image_base64 }}"
                                                            style="height: 100px;" alt="">
                                                    </div>
                                            ...
                                            <div class="profile-info-body bg-white">
                                                <div class="row g-4">
                                                    <div class="col-12">
                                                        <div class="form-container">
                                                            <input type="text" class="form-control shadow-none"
                                                                name="skills" placeholder="Type Here"
                                                                value="{{ $freelanferdetails->FS_skills }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="skill-cloud mt-4 d-flex align-items-center gap-3 flex-wrap">
                                                    @foreach ($skillsArray as $skill)
                                                        <span class="skill-cloud-item">
                                                            {{ $skill }}
                                                        </span>
                                                    @endforeach
                                                </div>

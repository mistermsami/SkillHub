                ...
                <div class="bg-white rounded-3 p-3">
                    <div class="row g-4">
                        <div class="col-lg-6 p-3 p-lg-5">
                            ...
                            <form action="{{ route('signinskillhub') }}" method="POST">
                                @csrf
                                <div class="form-container d-flex flex-column gap-4">
                                    <div class="form-input">
                                        ...
                                        @if (Cookie::get('user_email') != '')
                                            <input type="text" id="email" name="email"
                                                value="{{ Cookie::get('user_email') }}" placeholder="example@gmail.com"
                                                class="form-control shadow-none" />
                                        @else
                                            <input type="text" id="email" name="email"
                                                placeholder="example@gmail.com" class="form-control shadow-none" />
                                        @endif
                                    </div>
                                    <div class="form-input">
                                        ...
                                        @if (Cookie::get('user_password') != '')
                                            <input type="password" id="password" name="password"
                                                value="{{ Cookie::get('user_password') }}" placeholder="********"
                                                class="form-control shadow-none" />
                                        @else
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-2 form-input">
                                            @if (Cookie::get('user_password') != '')
                                            <input type="checkbox" name="remember" class="form-check" checked/>
                                            @else
                            ...
                            <div class="mt-4">
                                <p class="text-center form-text">
                                    ...
                                    <a href="{{ asset('signup') }}"> Create Account </a>
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
